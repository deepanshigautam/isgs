        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center mb-6">
              ...
              <div className="w-10 h-10 bg-isgs-white rounded-md flex items-center justify-center mr-3">
                <span className="text-isgs-black font-bold text-lg">IS</span>
              </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 rounded-full bg-isgs-charcoal flex items-center justify-center hover:bg-isgs-graphite transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-isgs-charcoal">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="/privacy-policy" className="text-isgs-smoke text-sm hover:text-isgs-white transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-isgs-smoke text-sm hover:text-isgs-white transition-colors">
                Terms of Service
              </Link>
            </div>
          </div>
